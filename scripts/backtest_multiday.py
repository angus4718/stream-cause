"""Multi-day quote-width MM backtest: calibrate k per instrument on IS, evaluate OOS."""
...
def main():
    ...
    def cal(name, sig):
        return calibrate_k(sig, is_qhs_tr, is_count_tr, is_pi_tr)
    ...
    # Hawkes-gate: post at best bid/ask (queue priority) when lambda_i(s) <= tau_i,
