...
// Top-50 Nasdaq-listed equities by 2022 dollar volume.
// IDs 0-49 assigned by descending volume.
const std::unordered_map<std::string, uint32_t> SYMBOL_TO_ID = {
    // Equities (0-49) -- top 50 by 2022 Nasdaq consolidated dollar volume
...
// Reverse mapping: internal ID -> symbol string.
